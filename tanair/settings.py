"""
Django settings for tanair project.
...
SECRET_KEY = 'django-insecure-%o4&b8z^!z#(=%wwpu#kz!mxbq#0%mv@$4(q*j*czp^dsh-)zg'
...
WSGI_APPLICATION = 'tanair.wsgi.application'
